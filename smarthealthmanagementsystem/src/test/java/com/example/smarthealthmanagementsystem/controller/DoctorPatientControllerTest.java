...
public class DoctorPatientControllerTest {
    ...
    public void testCreatePatient() {
        ...
        assertEquals("Patient added by doctor successfully", response.getBody());
    ...
    public void testUpdatePatientFound() {
        ...
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertEquals("Patient updated by doctor successfully", response.getBody());
    ...
    public void testDeletePatientFound() {
        ...
        assertEquals("Patient deleted by doctor successfully", response.getBody());
